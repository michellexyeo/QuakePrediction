...
public class QuakeTester
{
	...
	public int init(int sampleRate, int numOfSites, vector<double> sitesData,) {

	}

    public vector<double> forecast(int hour, vector<int> data, double K, vector<double> globalQuakes) {
